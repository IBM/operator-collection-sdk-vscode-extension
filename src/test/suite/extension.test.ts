...
describe('Extension Test Suite', async () => {
	...
	describe('When validating the Tree View', () => {
		...
		it('Should validate the IMS operator pod item', async () => {
			...
			let darkIconPath = (imsOperatorPod.iconPath as  {
				light: string | vscode.Uri;
				dark: string | vscode.Uri;
			}).dark;
			let lightIconPath = (imsOperatorPod.iconPath as  {
				light: string | vscode.Uri;
				dark: string | vscode.Uri;
			}).light;
		...
		it('Should validate the IMS ZosEndpoints', async () => {
			...
			const darkIconPath = (imsZosEndpoints[0].iconPath as {
				light: string | vscode.Uri;
				dark: string | vscode.Uri;
			}).dark;
			const lightIconPath = (imsZosEndpoints[0].iconPath as {
				light: string | vscode.Uri;
				dark: string | vscode.Uri;
			}).light;
			assert.equal((darkIconPath as vscode.Uri).path, getPassingIcons().dark.path);
		...
		it('Should validate the CICS ZosEndpoints', async () => {
			...
			const darkIconPath = (cicsZosEndpoints[0].iconPath as {
				light: string | vscode.Uri;
				dark: string | vscode.Uri;
			}).dark;
			const lightIconPath = (cicsZosEndpoints[0].iconPath as {
				light: string | vscode.Uri;
				dark: string | vscode.Uri;
			}).light;
			assert.equal((darkIconPath as vscode.Uri).path, getPassingIcons().dark.path);
		...
		it('Should validate the IMS OperatorCollections', async () => {
			...
			const darkIconPath = (imsOperatorCollections[0].iconPath as {
				light: string | vscode.Uri;
				dark: string | vscode.Uri;
			}).dark;
			const lightIconPath = (imsOperatorCollections[0].iconPath as {
				light: string | vscode.Uri;
				dark: string | vscode.Uri;
			}).light;
			assert.equal((darkIconPath as vscode.Uri).path, getPassingIcons().dark.path);
		...
		it('Should validate the IMS SubOperatorConfigs', async () => {
			...
			const darkIconPath = (imsSubOperatorConfigs[0].iconPath as {
				light: string | vscode.Uri;
				dark: string | vscode.Uri;
			}).dark;
			const lightIconPath = (imsSubOperatorConfigs[0].iconPath as {
				light: string | vscode.Uri;
				dark: string | vscode.Uri;
			}).light;
			assert.equal((darkIconPath as vscode.Uri).path, getPassingIcons().dark.path);
